                            ...
                            <div className="card card-registration my-4">
                                <div className="row g-0">
                                    <div className="col-xl-4 d-none d-xl-block">
                                        <img width='100%' height='100%' src="https://image.freepik.com/vrije-vector/staande-verpleegster-ziekenhuis-receptie-achtergrond_23-2147987275.jpg" alt="" />
                                    </div>
                                    <div className="col-xl-8">
                                        <div className="card-body p-md-5 text-black">
                                            <h3 className="mb-5 text-uppercase text-danger">Fenian Tourism
                                            ...
                                            <div>
                                                <p>Are you Already Register? Please <Link to='/login' >Login</Link></p>
                                            </div>
